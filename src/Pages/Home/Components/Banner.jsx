            ...
            <div className="relative mt-5">
                ...
                <div className="absolute z-[9998] top-1/2 px-5 md:px-20 lg:px-20 -translate-y-1/2 w-full">
                    <div className="w-full">
                        <h3 className="text-white text-sm font-semibold font-lato mb-3 md:mb-5 lg:mb-5 animate__animated animate__fadeInLeft">
                            Real Estate Searching Platform
                        </h3>

                        <h1 className="text-white font-lato text-xl md:text-3xl lg:text-5xl font-semibold leading-6 md:leading-8 lg:leading-[50px] w-[90%] md:w-[60%] lg:w-[40%] mb-3 md:mb-5 lg:mb-8 animate__animated animate__fadeInUp animate__delay-1s">
                        ...
                        <div className="divide-y md:divide-y-0 lg:divide-y-0 md:divide-x lg:divide-x flex flex-col md:flex-row lg:flex-row md:items-center lg:items-center bg-white rounded-lg w-full md:w-[80%] lg:w-[40%] md:pl-5 lg:pl-5 mb-6 animate__animated animate__fadeInLeft ">
                        ...
                        <div className="flex flex-col md:flex-row lg:flex-row gap-3 text-white items-center mb-5 md:mb-0 lg:mb-0 animate__animated animate__fadeInLeft">
